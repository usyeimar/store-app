...
class SuccessMessages{
    ...
    const SUCCESS_USER_VERIFY_EMAIL           = "236a0dd1f7e8c35a87f81949f37531fe";
    ...
    public function __construct()
    {
        $this->successList = [
            ...
            SuccessMessages::SUCCESS_USER_VERIFY_EMAIL => "Se ha enviado un correo electrónico con las instrucciones para el cambio de tu contraseña. Por favor verifica la información enviada"
        ];
    }
